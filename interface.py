...
iface = gr.Interface(
    ...
    examples=[
        ...
        os.path.join('captcha_examples', 'example06.png'),
        os.path.join('captcha_examples', 'example07.png'),
        os.path.join('captcha_examples', 'example08.png'),
        os.path.join('captcha_examples', 'example09.png'),
        os.path.join('captcha_examples', 'example10.png'),
    ],
